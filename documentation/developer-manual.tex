...
\fitTrackerTitle
  {Fit Tracker - Developer Manual}
  {Architecture, implementation, testing and maintenance - Version 0.1.2}
...
test, maintain and extend Fit Tracker. It describes the actual version 0.1.2
...
Version 0.1.2 intentionally contains one seeded user and no registration or
...
\begin{figure}[H]
  ...
  \caption{Version 0.1.2 passes eight backend and six frontend tests.}
\end{figure}
...
git tag -a v0.1.2 -m "Fit Tracker v0.1.2"
...
Version 0.1.2 has no registration route. An administrator can insert a user:
...
Version 0.1.2 intentionally does not provide workout editing or deletion, user
